...
Publish `config/scheduling.php` via `bin/cake manifest install --plugin Crustum/Scheduling` (see [Installation](Installation.md)), then configure monitoring behavior:
